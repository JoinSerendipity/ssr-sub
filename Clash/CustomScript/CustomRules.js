...
const ruleProviderSources = {
  "LocalAreaNetwork": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/LocalAreaNetwork.yaml",
  "ChatGPT": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/ChatGPT.yaml",
  "Netflix": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Netflix.yaml",
  "Taiwan": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Taiwan.yaml",
  "BILIBILI": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/bilibili.yaml",
  "SteamDownload": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/SteamDownload.yaml",
  "Steam": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Steam.yaml",
  "PikPak": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/PikPak.yaml",
  "HongKong": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/HongKong.yaml",
  "Tiktok": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Tiktok.yaml",
  "Twitch": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Twitch.yaml",
  "Disney": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Disney.yaml",
  "Japan": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Japan.yaml",
  "Korea": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Korea.yaml",
  "Epic": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Epic.yaml",
  "EpicDownload": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/EpicDownload.yaml",
  ...
  "ProxyList": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/ProxyList.yaml",
  "Proxy": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Proxy.yaml",
  "CustomDirect": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/CustomDirect.yaml",
  "ChinaDomain": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/ChinaDomain.yaml",
  "ChinaCompanyIp": "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/ChinaCompanyIp.yaml"
};
