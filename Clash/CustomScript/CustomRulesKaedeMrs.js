...
function main(config) {
  ...
  const createGroup = (name, regexStr = null) => {
    ...
    return {
      name,
      type: "select",
      proxies: specificProxies.length > 0 
  ...
  config.dns = {
    ...
    "nameserver-policy": {
      ...
      "rule-set:HongKong-Site": "https://cloudflare-dns.com/dns-query#🇭🇰 HongKong",
