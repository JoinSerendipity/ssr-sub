...
const ruleProviderSources = {
  LocalAreaNetwork: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/LocalAreaNetwork.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  ChatGPT: {
    url_yaml: null,
    url_mrs:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetMrs/ChatGPT.mrs",
    proxy: "DIRECT",
    behavior: "domain",
    interval: 86400,
  },
  Netflix: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Netflix.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  Taiwan: {
    url_yaml: null,
    url_mrs:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetMrs/Taiwan.mrs",
    proxy: "DIRECT",
    behavior: "domain",
    interval: 86400,
  },
  BILIBILI: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/bilibili.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  SteamDownload: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/SteamDownload.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  Steam: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Steam.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  PikPak: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/PikPak.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  HongKong: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/HongKong.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  Tiktok: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Tiktok.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  Twitch: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Twitch.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  Disney: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Disney.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  Japan: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Japan.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  Korea: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Korea.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  Epic: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Epic.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  EpicDownload: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/EpicDownload.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  Emby: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Emby.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  Porn: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Porn.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  BanAD: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/BanAD.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  Reject: {
    url_yaml: null,
    url_mrs:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetMrs/Reject.mrs",
    proxy: "DIRECT",
    behavior: "domain",
    interval: 86400,
  },
  BanProgramAD: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/BanProgramAD.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  Google: {
    url_yaml: null,
    url_mrs:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetMrs/Google.mrs",
    proxy: "DIRECT",
    behavior: "domain",
    interval: 86400,
  },
  GoogleCN: {
    url_yaml: null,
    url_mrs:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetMrs/GoogleCN.mrs",
    proxy: "DIRECT",
    behavior: "domain",
    interval: 86400,
  },
  Microsoft: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Microsoft.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  ProxyList: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/ProxyList.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  Proxy: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/Proxy.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  CustomDirect: {
    url_yaml:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetYaml/CustomDirect.yaml",
    url_mrs: null,
    proxy: "DIRECT",
    behavior: "classical",
    interval: 86400,
  ...
  ChinaDomain: {
    url_yaml: null,
    url_mrs:
      "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetMrs/ChinaDomain.mrs",
    proxy: "DIRECT",
    behavior: "domain",
    interval: 86400,
  },
  ...
  //   url_yaml: null,
  //   url_mrs:
  //     "https://cdn.jsdelivr.net/gh/JoinSerendipity/ssr-sub@master/Clash/RuleSetMrs/ChinaCompanyIp.mrs",
  //   proxy: "DIRECT",
  //   behavior: "ipcidr",
  //   interval: 86400,
  // },
